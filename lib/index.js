...
var SingleOtpInput = function (_PureComponent) {
  ...
  _createClass(SingleOtpInput, [{
    ...
    value: function render() {
      ...
      var pattern = isInputNum ? { pattern: NUMBERS_ONLY_PATTERN } : {};
...
var OtpInput = function (_Component) {
  ...
  function OtpInput() {
    ...
    return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref2 = OtpInput.__proto__ || Object.getPrototypeOf(OtpInput)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
    ...
    }, _this3.focusCurrentInput = function () {
      var activeInput = _this3.state.activeInput;

      _this3.focusInput(activeInput);
      ...
      var isValidValue = !_this3.props.isInputNum || !isNaN(e.target.value);
      if (isValidValue) {
      ...
      if (e.keyCode === BACKSPACE || e.key === 'Backspace') {
        ...
        e.preventDefault();
        _this3.focusNextInput();
      } else if (_this3.props.isInputNum && !RegExp(NUMBERS_ONLY_PATTERN).test(e.key.toString())) {
        e.preventDefault();
        _this3.focusCurrentInput();
      }
